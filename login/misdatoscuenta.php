    ...
    <ul class="sidenav-menu">
      <li>
        ...
        <ul class="sidenav-dropdown" data-sidenav-dropdown>
          ...
          <li><a href="javascript:;"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;<small>Agregar cuenta Bancaria</small></a></li>
    		...
    		<div class="row">
			    <div class="col-sm-8">
					   <div class="panel panel-success">
					      			<div class="panel-heading">REGISTRA AQUI TU NUMERO DE CUENTA DE BANCO</div>
							        <div class="panel-body">
							        	<form action="registrar.php" name="customForm" id="signupForm" method="POST" role="form" >
                                            <div class="signup-form-container">
                                                <div class="form-body">	    		
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon"><span class="glyphicon glyphicon-user texthead"></span></div>
                                                            <input id="username" name="username" type="text" class="form-control" value="<?php echo $row['user_name']; ?>"onfocus="this.blur()">
                                                            <div id="Info"></div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                    	<div class="input-group">
                                                         <div class="input-group-addon"><span class="glyphicon glyphicon-bitcoin texthead"></span></div>
			    										<input type="number" name="cuenta" id="cuenta" class="form-control" placeholder="numero de cuenta 10000012345678">
			    										</div>
                                                    </div>
                                                    <div class="form-group">
                                                    	<div class="input-group">
                                                         <div class="input-group-addon"><span class="glyphicon glyphicon-home texthead"></span></div>
			    										<input type="text" name="banco" id="banco" class="form-control" placeholder="Nombre del Banco">
			    										</div>
                                                    </div>
                                                    <div align="center">
                                                            <button type="submit" class="btn btn-primary btn-large"><i class="glyphicon glyphicon-ok"></i>&nbsp;&nbsp;Registrar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
		          ...
		          <div class="panel panel-primary">
		                ...
		                <div class="panel-body">
		                    <dl class="dl-horizontal">
                              ...
                              <dt>BANCO :</dt>
		                      <dd><b><?php echo $row['banco_user']; ?></b></dd>
    		...
    		<div class="row">
		        ...
		        <div class="col-sm-4">
		          <div class="panel panel-danger">
		            		<div class="panel-heading">LOS DATOS DEL AFILIADOR SON:</div>
		                <div class="panel-body">
		                    <dl class="dl-horizontal">
		                      <dt>NOMBRES :</dt>
		                      <dd><?php echo $row['user_name']; ?></dd>
